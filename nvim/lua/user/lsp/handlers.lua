...
local function lsp_keymaps(bufnr)
	...
	-- vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>ll", "<cmd>lua vim.diagnostic.open_float()<CR>", opts)
	...
	require("legendary").bind_command({ ":Format", ":lua vim.lsp.buf.formatting()", description = "Format Document" })
end
